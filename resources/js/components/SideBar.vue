<template>
    ...
    <nav
        ...
        :class="{show: mobileDropdown && isMobile}"
    >
        <div class="position-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a
                        class="btn btn-sm btn-secondary ms-3 mt-2"
                    ...
                    >
                        ...
                        <span class="ms-3">Read tutorial</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a
                        class="btn btn-sm btn-warning ms-3 mt-2"
                ...
                <li class="nav-item">
                    <a class="btn btn-sm btn-primary ms-3 mt-2" href="https://themesberg.com">By Themesberg ❤️</a>
                </li>
            </ul>
        </div>
    </nav>
